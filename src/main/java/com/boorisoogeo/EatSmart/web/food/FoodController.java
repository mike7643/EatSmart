...
public class FoodController {
    ...
    public String addFood(@Validated @ModelAttribute ("food") Food food, BindingResult result,RedirectAttributes redirectAttributes) {
        if (result.hasErrors()) {
            return "diet/foodAdd";
        }
    ...
    public String edit(@PathVariable Long foodId, @ModelAttribute FoodUpdateDto updateParam) {
